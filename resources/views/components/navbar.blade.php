...
>
    ...
    <div class="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <div class="hidden md:flex items-center space-x-6 font-medium">
            ...
            <div
                class="relative"
                @mouseenter="clearTimeout(timeout); openCampaign = true"
            ...
            >
                ...
                >
                    ...
                    <template x-for="category in categories" :key="category.slug">
                        <a
                            :href="`{{ route('campaign.index') }}?category=${category.slug}`"
                            class="block px-5 py-3 text-sm hover:bg-green-50"
        ...
        <div class="px-4 py-4 space-y-3 font-medium">
            ...
            <div>
                ...
                <div x-show="mobileCampaignOpen" x-transition class="pl-4 mt-2 space-y-2">
                    <a href="{{ route('campaign.index') }}"
                       class="block text-sm hover:text-green-600">
                        Semua Campaign
                    </a>
            ...
            @auth
                ...
                <form action="{{ route('logout') }}" method="POST">
                    @csrf
                    <button class="text-red-500 py-2">
                        Logout
                    </button>
                </form>
            @else

...
<div class="min-h-screen bg-gray-50">
    <div class="max-w-4xl mx-auto py-10 px-4">
        ...
        <div class="bg-white rounded-2xl shadow-sm border p-6 space-y-6">
            ...
            <div x-data="{ approve:false, reject:false }"
                 class="pt-6 border-t flex justify-end gap-3">
                    ...
                    <div @click.outside="approve=false"
                        ...
                        <div class="flex justify-center gap-3 mt-6">
                            ...
                            <form method="POST"
                                ...
                                @csrf
                                <button class="px-4 py-2 rounded-xl bg-green-500 hover:bg-green-600 text-white text-sm font-semibold">
                                    Ya, Approve
                                </button>
                            </form>
                        </div>
                ...
                <div x-show="reject" x-cloak
                     class="fixed inset-0 z-50 flex items-center justify-center bg-black/40">
                    <div @click.outside="reject=false"
                        ...
                        <form method="POST"
                            ...
                            <div class="flex justify-end gap-2">
                                ...
                                <button class="px-4 py-2 bg-red-500 hover:bg-red-600 text-white rounded-xl text-sm font-semibold">
                                    Tolak
                                </button>
                            </div>
                        </form>
